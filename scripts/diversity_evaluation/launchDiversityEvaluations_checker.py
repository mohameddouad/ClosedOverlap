...
# searchstrategies = ["FIRSTWITCOV", "MINCOV"]
...
if __name__ == "__main__":
    ...
    procs = dict()
    queue = mp.Queue()
    scriptFileName = "jaccardsEvaluations_checker.py"
