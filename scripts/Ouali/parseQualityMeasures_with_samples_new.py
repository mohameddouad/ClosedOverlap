    ...
    if content_param:
        ...
        if found:
            ...
            if nbrL <= samples:
                ...
                # print("trial", co, ":", val)
                print("\n\n")
                print("\n", data_name, "--> ClosedPattern PCR:", val, 
                  "\n\n\n-------------------------------------", 
                  "\n-------------------------------------\n\n")
                return val
                ...
                for co in range(0, trials):
                    ...
                    for s in range(debut, fin):
                        random.seed(s)
                        rnd_index = random.randint(0, nbrL)
                        all_indexes.append(rnd_index)
...
def readClosedDiversityNew(content_param, info=0):
    ...
    if content_param:
        ...
        if found:
            ...
            // réduire l'indentation d'un niveau pour les lignes qui suivent
            else:
                print(val)
                return val
            """
