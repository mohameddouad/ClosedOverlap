...
#               "german-credit.dat" : ["0.1", "0.01", "0.001", "0.025"],
#               "hepatitis.dat" : ["0.2"],
#               "mushroom.dat" : ["0.2", "0.1", "0.05"], ----
#               "pumsb.dat" : [ "0.70", "0.4", "0.1"],
#               "retail.dat" : [ "0.1", "0.05", "0.01", "0.005", "0.003" ],
#               "T10I4D100K.dat" : [ "0.05", "0.01", "0.005" ],
#               "vote.dat" : ["0.1", "0.01", "0"],
#               "heart-cleveland.dat" : [ "0.3", "0.2", "0.1", "0.05"],
#               "kr-vs-kp.dat" : ["0.4", "0.3"],
#               "primary-tumor.dat" : [ "0.1", "0.01", "0"],
#               "splice1.dat" : [ "0.1", "0.05", "0.01" ],
#               "T40I10D100K.dat" : [ "0.2", "0.1" ],
#               "ijcai16.dat": ["0.3", "0.2", "0.1"]
               }
jmax = "0.25"  # maximum jaccard-similarity threshold
...
def closedDiversity(queue, project_bin_file, project_data_dir, project_res_dir, config):
    ...
    try:
        ...
        absolute_dataset_res_dir = os.path.abspath(os.path.join(project_res_dir, "ClosedDiversity_V2", config[0].split('.')[0]))
