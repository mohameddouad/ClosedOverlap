...
#               "vote.dat" : ["0.1", "0.01", "0"],
               ...
               "heart-cleveland.dat" : [ "0.1", "0.2", "0.25", "0.3", "0.35", "0.4", "0.45", "0.5", "0.6", "0.7" ],
               "kr-vs-kp.dat" : ["0.1", "0.2", "0.25", "0.3", "0.35", "0.4", "0.45", "0.5", "0.6", "0.7" ],
#               "primary-tumor.dat" : [ "0.1", "0.01", "0"],
               "splice1.dat" : [ "0.1", "0.2", "0.25", "0.3", "0.35", "0.4", "0.45", "0.5", "0.6", "0.7" ],
               "T40I10D100K.dat" : [ "0.1", "0.2", "0.25", "0.3", "0.35", "0.4", "0.45", "0.5", "0.6", "0.7" ]
#               'ijcai16.dat': ["0.3", "0.2", "0.1"]
               }
...
def closedDiversity(queue, project_bin_file, project_data_dir, project_res_dir, config):
    ...
    try:
        ...
        absolute_dataset_res_dir = os.path.abspath(os.path.join(project_res_dir, "ClosedDiversityFIRSTWITCOV_V2", config[0].split('.')[0]))
...
if __name__ == '__main__':
    ...
    for i in range(0, npr):
        if curr < len(configs):
            ...
            proc = Process(target=closedDiversity, args=(queue, project_bin_closed_diversity_v2_file, project_data_dir, project_res_dir, configs[curr],))
            proc.start()
