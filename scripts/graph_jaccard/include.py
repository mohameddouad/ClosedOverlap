...
project_bin_closed_diversity_new_estFreq_file = os.path.abspath(os.path.join(project_dir, "target", "ClosedDiversityNew_estFreq-choco4-0-3-jar-with-dependencies.jar"))
project_bin_closed_diversity_v2_file = os.path.abspath(os.path.join(project_dir, "target", "ClosedDiversity_v2-choco4-0-3-jar-with-dependencies.jar"))
project_bin_closed_diversity_v2_estFreq_file = os.path.abspath(os.path.join(project_dir, "target", "ClosedDiversity_v2_estFreq-choco4-0-3-jar-with-dependencies.jar"))
...
project_bin_closed_diversity_topk_2_file = os.path.abspath(os.path.join(project_dir, "target", "ClosedDiversityTopK_2-choco4-0-3-jar-with-dependencies.jar"))
